...
import codemirror.eclipse.swt.xml.builder.CMXMLBuilder;
import codemirror.eclipse.swt.xml.builder.CMXMLRunModeBuilder;
...
public class Activator extends AbstractUIPlugin {
	...
	public void start(BundleContext context) throws Exception {
		...
		CMBuilderRegistry.getInstance().register(
				new CMXMLBuilder(CMResourcesRegistry.getRegistry().getURL("")));
		CMRunModeBuilderRegistry.getInstance().register(
				new CMXMLRunModeBuilder(CMResourcesRegistry.getRegistry()
						.getURL("")));
	}
