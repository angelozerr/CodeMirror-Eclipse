...
import codemirror.eclipse.swt.json.builder.CMJsonRunModeBuilder;
...
public class Activator extends AbstractUIPlugin {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "codemirror.eclipse.ui.json"; //$NON-NLS-1$
	...
	public void start(BundleContext context) throws Exception {
		...
		CMBuilderRegistry.getInstance()
				.register(
						new CMJsonBuilder(CMResourcesRegistry.getRegistry()
								.getURL("")));
		CMRunModeBuilderRegistry.getInstance().register(
				new CMJsonRunModeBuilder(CMResourcesRegistry.getRegistry()
						.getURL("")));
	}
