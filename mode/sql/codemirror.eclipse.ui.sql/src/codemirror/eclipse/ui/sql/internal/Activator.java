...
import codemirror.eclipse.swt.sql.builder.CMSQLRunModeBuilder;
...
public class Activator extends AbstractUIPlugin {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "codemirror.eclipse.ui.sql"; //$NON-NLS-1$
	...
	public void start(BundleContext context) throws Exception {
		...
		CMBuilderRegistry.getInstance().register(
				new CMSQLBuilder(CMResourcesRegistry.getRegistry().getURL("")));
		CMRunModeBuilderRegistry.getInstance().register(
				new CMSQLRunModeBuilder(CMResourcesRegistry.getRegistry()
						.getURL("")));
	}
