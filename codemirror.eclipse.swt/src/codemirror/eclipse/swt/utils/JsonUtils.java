...
public abstract class JsonUtils {
   ...
   *          characters {@code <}, {@code >}, {@code &} and {@code =} before
   ...
   *          valeur du champs.
   * @param firstField
   *          vaut true si le champs est le premier champs et false sinon (pour
   *          générer une virgule ou non).
   * @param writer
   *          dans lequel on doit ecrire le champs simple JSON.
   * @throws IOException
   */
  public static void addJsonField(String name, boolean value, boolean firstField, Writer writer) throws IOException {
   ...
   * @throws IOException
   */
  public static void addJsonField(String name, boolean value, boolean firstField, boolean nameQuoted, Writer writer) throws IOException {
   ...
   * @throws IOException
   */
  public static void addJsonField(String name, int value, boolean firstField, Writer writer) throws IOException {
    addJsonField(name, value, firstField, false, writer);
  }

  /**
   * Ajout un champs simple JSON de nom et valeur de type entier en indiquant si
   ...
   * @throws IOException
   */
  public static void addJsonField(String name, int value, boolean firstField, boolean nameQuoted, Writer writer) throws IOException {
   ...
   * @throws IOException
   */
  public static void addJsonField(String name, long value, boolean firstField, Writer writer) throws IOException {
    addJsonField(name, value, firstField, false, writer);
  }
   ...
   * @throws IOException
   */
  public static void addJsonField(String name, long value, boolean firstField, boolean nameQuoted, Writer writer) throws IOException {
   ...
   * @throws IOException
   */
//  public static void addJsonField(String name, Date value, boolean firstField, Writer writer) throws IOException {
//    addJsonField(name, value, firstField, false, writer);
//  }
   ...
   * @throws IOException
   */
//  public static void addJsonField(String name, Date value, boolean firstField, boolean nameQuoted, Writer writer) throws IOException {
//    String s = (value != null ? ExtendedFunctions.formatDatetime(value, StringUtils.DATE_TIME_PATTERN) : "");
...
//  }
   ...
   * @throws IOException
   */
  public static void addJsonField(String name, String value, boolean firstField, Writer writer) throws IOException {
    addJsonField(name, value, firstField, false, writer);
  }

  /**
   * Ajout un champs simple JSON de nom et valeur de type String en indiquant si
   * le nom du champs doit etre quotté on non.
   * 
   * @param name
   *          nom du champs.
   ...
   * @throws IOException
   */
  public static void addJsonField(String name, String value, boolean firstField, boolean nameQuoted, Writer writer) throws IOException {
   ...
   * @throws IOException
   */
  private static void addJsonField(String name, String value, boolean firstField, boolean nameQuoted, boolean valueQuoted, Writer writer)
                                                                                                                                         throws IOException {
    if (!firstField) {
   ...
   * @throws IOException
   */
  public static void addString(String s, boolean quoted, Writer writer) throws IOException {
    if (quoted) {
      writer.write("\"");
